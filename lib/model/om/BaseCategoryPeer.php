...
abstract class BaseCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CategoryId', 'Name', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('categoryId', 'name', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::CATEGORY_ID, self::NAME, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('category_id', 'name', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CategoryId' => 0, 'Name' => 1, 'Description' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('categoryId' => 0, 'name' => 1, 'description' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::CATEGORY_ID => 0, self::NAME => 1, self::DESCRIPTION => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('category_id' => 0, 'name' => 1, 'description' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(CategoryPeer::CATEGORY_ID);
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Category) {
				$key = (string) $value->getCategoryId();
    ...
    foreach (sfMixer::getCallables('BaseCategoryPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoryPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(CategoryPeer::CATEGORY_ID) && $criteria->keyContainsValue(CategoryPeer::CATEGORY_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.CategoryPeer::CATEGORY_ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseCategoryPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoryPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CategoryPeer::CATEGORY_ID);
			$selectCriteria->add(CategoryPeer::CATEGORY_ID, $criteria->remove(CategoryPeer::CATEGORY_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CategoryPeer::CATEGORY_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CategoryPeer::CATEGORY_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CategoryPeer::DATABASE_NAME);
			$criteria->add(CategoryPeer::CATEGORY_ID, $pks, Criteria::IN);
