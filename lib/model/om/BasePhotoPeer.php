...
abstract class BasePhotoPeer {
	...
	/** the column name for the CONTEXT_ID field */
	const CONTEXT_ID = 'photo.CONTEXT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PhotoId', 'Context', 'ContextId', 'Title', 'Caption', 'Filename', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('photoId', 'context', 'contextId', 'title', 'caption', 'filename', ),
		BasePeer::TYPE_COLNAME => array (self::PHOTO_ID, self::CONTEXT, self::CONTEXT_ID, self::TITLE, self::CAPTION, self::FILENAME, ),
		BasePeer::TYPE_FIELDNAME => array ('photo_id', 'context', 'context_id', 'title', 'caption', 'filename', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PhotoId' => 0, 'Context' => 1, 'ContextId' => 2, 'Title' => 3, 'Caption' => 4, 'Filename' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('photoId' => 0, 'context' => 1, 'contextId' => 2, 'title' => 3, 'caption' => 4, 'filename' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::PHOTO_ID => 0, self::CONTEXT => 1, self::CONTEXT_ID => 2, self::TITLE => 3, self::CAPTION => 4, self::FILENAME => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('photo_id' => 0, 'context' => 1, 'context_id' => 2, 'title' => 3, 'caption' => 4, 'filename' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		$criteria->addSelectColumn(PhotoPeer::PHOTO_ID);
		$criteria->addSelectColumn(PhotoPeer::CONTEXT);
		$criteria->addSelectColumn(PhotoPeer::CONTEXT_ID);
		$criteria->addSelectColumn(PhotoPeer::TITLE);
		$criteria->addSelectColumn(PhotoPeer::CAPTION);
    ...
    foreach (sfMixer::getCallables('BasePhotoPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePhotoPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PhotoPeer::PHOTO_ID);
			$selectCriteria->add(PhotoPeer::PHOTO_ID, $criteria->remove(PhotoPeer::PHOTO_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PhotoPeer::PHOTO_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(PhotoPeer::PHOTO_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PhotoPeer::DATABASE_NAME);
			$criteria->add(PhotoPeer::PHOTO_ID, $pks, Criteria::IN);
