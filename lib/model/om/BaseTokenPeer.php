...
abstract class BaseTokenPeer {
	...
	const ACCOUNT_ID = 'token.ACCOUNT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('TokenId', 'AccountId', 'ExpiresAt', 'Token', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('tokenId', 'accountId', 'expiresAt', 'token', ),
		BasePeer::TYPE_COLNAME => array (self::TOKEN_ID, self::ACCOUNT_ID, self::EXPIRES_AT, self::TOKEN, ),
		BasePeer::TYPE_FIELDNAME => array ('token_id', 'account_id', 'expires_at', 'token', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('TokenId' => 0, 'AccountId' => 1, 'ExpiresAt' => 2, 'Token' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('tokenId' => 0, 'accountId' => 1, 'expiresAt' => 2, 'token' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::TOKEN_ID => 0, self::ACCOUNT_ID => 1, self::EXPIRES_AT => 2, self::TOKEN => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('token_id' => 0, 'account_id' => 1, 'expires_at' => 2, 'token' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(TokenPeer::TOKEN_ID);
		$criteria->addSelectColumn(TokenPeer::ACCOUNT_ID);
	...
	public static function doCountJoinAccount(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TokenPeer::ACCOUNT_ID, AccountPeer::ACCOUNT_ID, $join_behavior);
	...
	/**
	 * Selects a collection of Token objects pre-filled with their Account objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAccount(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Token) to $obj2 (Account)
				$obj2->addToken($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Token) to the collection in $obj2 (Account)
				$obj2->addToken($obj1);
    ...
    foreach (sfMixer::getCallables('BaseTokenPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseTokenPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(TokenPeer::TOKEN_ID);
			$selectCriteria->add(TokenPeer::TOKEN_ID, $criteria->remove(TokenPeer::TOKEN_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(TokenPeer::TOKEN_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(TokenPeer::TOKEN_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(TokenPeer::DATABASE_NAME);
			$criteria->add(TokenPeer::TOKEN_ID, $pks, Criteria::IN);
