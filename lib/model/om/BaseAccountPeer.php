...
abstract class BaseAccountPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('AccountId', 'Email', 'Password', 'FirstName', 'LastName', 'Status', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('accountId', 'email', 'password', 'firstName', 'lastName', 'status', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ACCOUNT_ID, self::EMAIL, self::PASSWORD, self::FIRST_NAME, self::LAST_NAME, self::STATUS, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('account_id', 'email', 'password', 'first_name', 'last_name', 'status', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('AccountId' => 0, 'Email' => 1, 'Password' => 2, 'FirstName' => 3, 'LastName' => 4, 'Status' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('accountId' => 0, 'email' => 1, 'password' => 2, 'firstName' => 3, 'lastName' => 4, 'status' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ACCOUNT_ID => 0, self::EMAIL => 1, self::PASSWORD => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::STATUS => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('account_id' => 0, 'email' => 1, 'password' => 2, 'first_name' => 3, 'last_name' => 4, 'status' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
    ...
    foreach (sfMixer::getCallables('BaseAccountPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseAccountPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(AccountPeer::ACCOUNT_ID, $criteria->remove(AccountPeer::ACCOUNT_ID), $comparison);
