...
class CategoryTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('CATEGORY_ID', 'CategoryId', 'INTEGER', true, 11, null);
	...
	{
    $this->addRelation('ListingToCategory', 'ListingToCategory', RelationMap::ONE_TO_MANY, array('category_id' => 'category_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
